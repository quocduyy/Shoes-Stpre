		...
		<div class="p-t-40">
			<div class="flex-c-m flex-w p-b-18">
				<a href="#" class="m-all-1"> <img
					 src="<c:url value='/template/web/images/icons/icon-pay-01.png'/>" alt="ICON-PAY"> 
				</a> <a href="#" class="m-all-1"> <img
					
					src="<c:url value='/template/web/images/icons/icon-pay-02.png'/>" alt="ICON-PAY">
				</a> <a href="#" class="m-all-1"> <img
					
					src="<c:url value='/template/web/images/icons/icon-pay-03.png'/>" alt="ICON-PAY">
				</a> <a href="#" class="m-all-1"> <img
					
					src="<c:url value='/template/web/images/icons/icon-pay-04.png'/>" alt="ICON-PAY">
				</a> <a href="#" class="m-all-1"> <img
					
					src="<c:url value='/template/web/images/icons/icon-pay-05.png'/>" alt="ICON-PAY">
				</a>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<p class="stext-102 cl3 p-t-23">accae eros pharetra viverra.
